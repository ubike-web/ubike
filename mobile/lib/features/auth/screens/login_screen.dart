...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      final res = await ApiClient.instance.post('/user/login', data: {'email': email, 'password': pass});
      await ApiClient.instance.saveToken(res['token']);
      await ApiClient.instance.saveUserType('user');
      if (!mounted) return;
      context.go('/home');
          ...
          child: Column(
            ...
            children: [
              Column(
                ...
                children: [
                  const Text('User Login\u{1F9D1}\u{1F3FB}', style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold)),
              ...
              Column(
                children: [
                  AuthButton(
                    ...
                    onPressed: () => context.go('/captain/login'),
                  ),
